...
function hideForm(){
    document.querySelector("#myForm").classList.add('d-none') // don't display form
    document.querySelector("#cards").classList.remove('d-none') // display form
}

function hideCards(){
    document.querySelector("#myForm").classList.remove('d-none') // don't display form
    document.querySelector("#cards").classList.add('d-none') // display form
}
...
function displayCards(){
    ...
    for(let c of cards){
        //use bootstrap cards to make post cards
        cards_html += `
